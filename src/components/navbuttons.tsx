  ...
  return (
    <div className="flex items-center justify-around bg-white p-4 text-slate-400 md:hidden">
      <div
        ...
        className="flex h-10 grow items-center justify-center rounded-xl bg-gray-100"
      >
      ...
      <div
        ...
        className="hover:bg-gray-1001 flex h-10 grow items-center justify-center rounded-xl"
      >
